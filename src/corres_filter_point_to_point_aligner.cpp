...
{
    ros::init(argc, argv, "corres_filter_point_to_point_aligner");     
    ...
    boost::shared_ptr<pc_alignment_tools::correspondences_filtering_pipeline_aligner<pc_alignment_tools::P_type, 
                      pc_alignment_tools::ApproximatePolicy, 
                      pc_alignment_tools::corres_filter_point_to_point_aligner>> 
            pc_aligner(new pc_alignment_tools::correspondences_filtering_pipeline_aligner<pc_alignment_tools::P_type, 
                       pc_alignment_tools::ApproximatePolicy, 
                       pc_alignment_tools::corres_filter_point_to_point_aligner>
