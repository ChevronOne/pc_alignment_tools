...
{
    ros::init(argc, argv, "point_to_plane_aligner");     
    ...
    boost::shared_ptr<pc_alignment_tools::pc_aligner<pc_alignment_tools::PN_type, 
                        pc_alignment_tools::ApproximatePolicy, 
                        pc_alignment_tools::point_to_plane_aligner>> 
            pc_aligner(new pc_alignment_tools::pc_aligner<pc_alignment_tools::PN_type, 
                                pc_alignment_tools::ApproximatePolicy, 
                                pc_alignment_tools::point_to_plane_aligner>
