...
{
    ros::init(argc, argv, "nl_point_to_point_aligner");     
    ...
    boost::shared_ptr<pc_alignment_tools::pc_aligner<pc_alignment_tools::P_type, 
                        pc_alignment_tools::ApproximatePolicy, 
                        pc_alignment_tools::nl_point_to_point_aligner>> 
            pc_aligner(new pc_alignment_tools::pc_aligner<pc_alignment_tools::P_type, 
                                pc_alignment_tools::ApproximatePolicy, 
                                pc_alignment_tools::nl_point_to_point_aligner>
